<%@ Page Title="Read Gravedigger" MasterPageFile="~/Site.Master" Language="C#" AutoEventWireup="true" CodeBehind="Read Gravedigger.aspx.cs" Inherits="PatrickAuthorSite.Pages.Read_Gravedigger" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <asp:Panel runat="server" CssClass="styledPanel styledPanelSmall panel">
            ...
            <p>Illustration by Aric Salyer, please see the <a href="Credits.aspx">Credits page</a> for more of his work.</p>

        </asp:Panel>

        <asp:Panel runat="server" CssClass="styledPanel styledPanelSmall panel">
            <p class="styledHeader">Table of Contents</p>
        ...
        <a name="stranger"></a>
        <asp:Panel runat="server" CssClass="styledPanel styledPanelSmall panel">
            <p class="styledHeader">The Stranger</p>
    ...
    if the stranger would spare a glance at the gravesite of the man he'd just killed as he passed it by. He did no such thing.
        ...
        <a name="wayward"></a>
        <asp:Panel runat="server" CssClass="styledPanel styledPanelSmall panel">
            <p class="styledHeader">The Wayward and the Dead</p>
    ...
    horse back towards the caravan, the bodies, and his long work ahead.
        ...
        <a name="peekers"></a>
        <asp:Panel runat="server" CssClass="styledPanel styledPanelSmall panel">
            <p class="styledHeader">Peeker’s Peak</p>
    ...
    smoke. After that, the Gravedigger had seen enough. He coaxed his horse in a south-east direction, and the horse took him that way.
        ...
        <a name="serenidad"></a>
        <asp:Panel runat="server" CssClass="styledPanel styledPanelSmall panel">
            <p class="styledHeader">Serenidad</p>
    ...
    unfortunate occurrence at Serenidad had delayed his hunt for the outlaw only temporarily. With that in mind, the Gravedigger gave his answer:
        ...
        <a name="little"></a>
        <asp:Panel runat="server" CssClass="styledPanel styledPanelSmall panel">
            <p class="styledHeader">Little People and Lost Souls</p>
    ...
    the Gravedigger could accept the last of these.
        ...
        <a name="tennessee"></a>
        <asp:Panel runat="server" CssClass="styledPanel styledPanelSmall panel">
            <p class="styledHeader">One Tennessee Night</p>
    ...
    knowledge that wherever the Girl was, she rested well.
        ...
        <a name="note"></a>
        <asp:Panel runat="server" CssClass="styledPanel styledPanelSmall panel">
            <p class="styledHeader">Author's Note</p>
